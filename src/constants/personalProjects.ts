...
export const personalProjects : personalProjectType[] =[{
    ...
    whatIHaveLearned : ["building large complex web apps with typescript ,mern , redux " , "contributing to open source projects and use git to manage app versions and branches" , "building great user interfaces with mui  and figma " , "implementing design patterns to make my code clean and manageble"  , "ussing looks such as typescript , design patterns to make my code clean and optmizble in the future" , "implementing authorization technologies such as jwt to authonticate and authorize user" ] ,
    ...
    whatIHaveLearned : ["building complex web app ussing firebase as a database"  , "working with material ui and figma to build an outstanding ui and ux"  ] ,
