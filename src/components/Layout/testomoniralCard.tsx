...
return <div  className="flex max-w-xl testomonialCard flex-col items-center px-4 py-9  bg-black border-2 rounded-xl laptop:w-1/3 border-whiteYellwed gap-6" >
