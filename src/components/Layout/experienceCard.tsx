...
export const ExperienceCard : React.FC<experienceType> = ({title , company , technologies  , url , logo })=>{
    return <div className="relative w-full  laptop:w-1/3" ><motion.div initial={{bottom: '0px'}} whileHover={{bottom : '20px'}}  className="flex relative  cursor-cell flex-col w-full bg-white text-black rounded-t-xl  border-gray-700 rounded-xl  " >
