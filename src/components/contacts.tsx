...
export const ContactForm : React.FC = ()=>{
    return<div className=" flex w-full relative items-center justify-center bg-black" >
...
<Text  className="text-xl text-center laptop:text-start ">Leave us a little info, and we&apos;ll be in touch.</Text>
</div>
...
<div className="w-full flex  items-center justify-center" ><button style={{borderWidth : '0.25px'}} className =" bg-gray-800 text-whiteYellwed rounded-lg  font-bold py-2 px-8 border-whiteYellwed hover:border-0 hover:bg-gray-900 w-fit">
