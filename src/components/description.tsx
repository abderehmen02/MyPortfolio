...
export const Description = ()=>{
    return <div className="flex flex-col w-full  items-center bg-gray-900 px-12 py-20 bg-ternary text-white justify-center gap-7  " >
<BlodText className="text-4xl font-bold text-whiteYellwed" >Hi, I’m Abde Rahmane</BlodText>
<Text>
<ul className="list-disc font-semibold capitalize text-xl gap-3 flex flex-col " >
 <li>   i help people build and manage their software apps ussing mern stack and next js t  </li>
